  ...
  return SizedBox(
    ...
    child: Padding(
      ...
      child: Row(
        ...
        children: [
          IconButton( icon: const Icon(Icons.menu), color: Colors.black,onPressed:menuPressed,),
          Center(child: Text(titlePage , style: const TextStyle(fontSize: 20,fontWeight: FontWeight.bold,height: 1),)),
