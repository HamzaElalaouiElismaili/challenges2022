...
import 'package:challenges2022/first%20month/Modules/MainPage/HomePage/homepage.dart';
...
class CompleteInfo extends StatelessWidget {
  ...
  final TextEditingController upBioController = TextEditingController(text: userModel.bio);
